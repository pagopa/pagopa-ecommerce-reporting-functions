 ...
 *
 * import com.azure.data.tables.TableClient; import
 * com.fasterxml.jackson.databind.JsonNode; import
 * com.fasterxml.jackson.databind.node.TextNode; import
 * com.microsoft.azure.functions.ExecutionContext; import
 * it.pagopa.ecommerce.reporting.clients.EcommerceHelpdeskServiceClient; import
 ...
 * uk.org.webcompere.systemstubs.environment.EnvironmentVariables; import
 * uk.org.webcompere.systemstubs.jupiter.SystemStub; import
 ...
 *
 * @ExtendWith(MockitoExtension.class) public class ReadDataServiceTest {
 *
 * @SystemStub private EnvironmentVariables variables = new
 * EnvironmentVariables( "ECOMMERCE_CLIENTS_LIST", "[\"CLIENT_1\",\"CLIENT2\"]",
 * "ECOMMERCE_PAYMENT_METHODS_TYPE_CODE_LIST", "[\"PAY_1\",\"PAY_2\"]",
 * "ECOMMERCE_PAYMENT_METHODS_PSP_LIST",
 * "{\"PAY_1\":[\"PSP_1\",\"PSP_2\"],\"PAY_2\":[\"PSP_3\",\"PSP_2\"]}" );
 *
 * private Logger mockLogger;
 *
 * @Mock EcommerceHelpdeskServiceClient ecommerceHelpdeskServiceClient;
 *
 * @BeforeEach void setUp() { mockLogger = mock(Logger.class); // service = new
 * TransactionStatusAggregationService(mockTableClient); }
 *
